  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <h1><i>Fusion Taco</i></h1>

<iframe height='320' scrolling='no' title='Responsive Google Map' src='hmmaps/ftmap.html' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
...
<p>Asian mixed with Latin, they have wine & beer are offered you get the food-truck taste in store form </p>
<BR>
<BR>
...
$sql = "SELECT * FROM  `Food Menu` WHERE  `rest_id` =  '25' ";
...
$sql = "SELECT * FROM  `wifi` WHERE  `wifi_id` =  '25' ";
...
$sql = "SELECT * FROM  `events` WHERE  `event_id` =  '25' ";
...
$sql = "SELECT * FROM  `vendors` WHERE  `vend_id` =  '25' ";
...
$sql = "SELECT * FROM  `staff` WHERE  `staff_id` =  '25' ";
...
$sql = "SELECT * FROM  `Parking` WHERE  `park_id` =  '25' ";
$result = $conn ->query($sql);
...
$sql = "SELECT * FROM  `payment method` WHERE  `payment_id` =  '25' ";
$result = $conn ->query($sql);
...
<iframe height='375' scrolling='yes' title='Responsive Google Map' src='/commentbox/tablescomments/comet9.php' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
