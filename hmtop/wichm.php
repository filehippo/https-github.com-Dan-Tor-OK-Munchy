  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <h1><i>Which wich</i></h1>

<iframe height='320' scrolling='no' title='Responsive Google Map' src='hmmaps/wichmap.html' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
...
<p>This Place is a great Subway substitute it really does has superior sandwiches its a good walk from UHD but its well worth it  </p>
<BR>
<BR>
...
$sql = "SELECT * FROM  `Food Menu` WHERE  `rest_id` =  '22' ";
...
$sql = "SELECT * FROM  `wifi` WHERE  `wifi_id` =  '22' ";
...
$sql = "SELECT * FROM  `events` WHERE  `event_id` =  '22' ";
...
$sql = "SELECT * FROM  `vendors` WHERE  `vend_id` =  '22' ";
...
$sql = "SELECT * FROM  `staff` WHERE  `staff_id` =  '22' ";
...
$sql = "SELECT * FROM  `Parking` WHERE  `park_id` =  '22' ";
$result = $conn ->query($sql);
...
$sql = "SELECT * FROM  `payment method` WHERE  `payment_id` =  '22' ";
$result = $conn ->query($sql);
...
<iframe height='375' scrolling='yes' title='Responsive Google Map' src='/commentbox/tablescomments/comet6.php' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
