...
<html lang="en">
  <head>
    ...
    <title>OKM Brown Bag Deli</title>
  ...
  <body>
    ...
    <div class="container">
      <div class="starter-template">
        ...
        <h1><i>Brown Bag Deli</i></h1>

<iframe height='320' scrolling='no' title='Responsive Google Map' src='hmmaps/brownmap.html' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
...
<p>Chain sandwiche shop fair tasting sandwiches. Each sandwich is custom made  to order.</p>
<BR>
<BR>
...
$sql = "SELECT * FROM  `Food Menu` WHERE  `rest_id` =  '21' ";
...
$sql = "SELECT * FROM  `wifi` WHERE  `wifi_id` =  '21' ";
...
$sql = "SELECT * FROM  `events` WHERE  `event_id` =  '21' ";
...
$sql = "SELECT * FROM  `vendors` WHERE  `vend_id` =  '21' ";
...
$sql = "SELECT * FROM  `staff` WHERE  `staff_id` =  '21' ";
...
$sql = "SELECT * FROM  `Parking` WHERE  `park_id` =  '21' ";
$result = $conn ->query($sql);
...
$sql = "SELECT * FROM  `payment method` WHERE  `payment_id` =  '21' ";
$result = $conn ->query($sql);
...
<iframe height='375' scrolling='yes' title='Responsive Google Map' src='/commentbox/tablescomments/comet5.php' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>        
</iframe>
